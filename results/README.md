...
The two held-out readings — `frozen-test/frozen_test_scores.json` (v0.8, null)
and `v010/test2_scores.json` (v0.10, positive) — were each generated by opening
their set exactly once. Neither will be regenerated, because reopening a
held-out set would void the discipline that makes it meaningful.
